...
public class CalendarDayTextView extends AppCompatTextView {
    ...
    private int emptyColor = getResources().getColor(R.color.date_duration_bg);
    private int fillColor = getResources().getColor(R.color.date_duration_bg);
    ...
    private void initview(Context context) {
        ...
        mPaintSTime.setColor(context.getResources().getColor(R.color.text_bg_seled));
        mPaintSTime.setStrokeWidth(2);

        mPaintETime = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaintETime.setStyle(Paint.Style.FILL);
        mPaintETime.setColor(context.getResources().getColor(R.color.text_bg_seled));
    ...
    public void isETime(boolean etime) {
        isETime = etime;
        this.setTextColor(context.getResources().getColor(R.color.text_colored));
    }
